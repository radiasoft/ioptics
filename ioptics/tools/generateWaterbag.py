...
if __name__ == '__main__':
    ...
    myBunchGenerator = ellipticBeam(0.4, 0.01, 0.637494274, 0.0)

    list0 = np.array(myBunchGenerator.generateBunch(20.00e-6, 100000))
    ...
    for idx in range(0,100000):
        ptclString = str(list0[idx,0])+' '+str(list0[idx,1])+' '+str(list0[idx,2])+' '+str(list0[idx,3])+' '+str(0.000000)+' '+str(0.000000)+'\n'
